...
function App() {
  ...
  const fetchCryptoData = async () => {
    ...
    const data = await fetch('http://127.0.0.1:8000/stocklist/');
    // const data = await axios.get("http://127.0.0.1:8000/stocklist/")
                  ...
                  <td className="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                    <div className="flex">
                      ...
                      <div className="ml-3">
                        ...
                        <p className="text-gray-600 whitespace-no-wrap">{cryptocurrency.coin_name}</p>
                      </div>
                    </div>
                  </td>
                  <td className="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                    <p className="text-gray-900 whitespace-no-wrap">${cryptocurrency.coin_price}</p>
